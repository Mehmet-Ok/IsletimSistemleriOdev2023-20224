...
public class Memory {
	...
	public void allocateUserProcess(Process p) {
		...
		if(p.priority != 0)
		{
			//System.out.println("AAA emptyFrame="+emptyFrameCount+", pr.pageCount="+p.pageCount);
...
//					}
				...
				p.isAllocate = true;
				System.out.println("tahsis edilen proses="+p.id+", pageCount="+p.pageCount+", ramde kalan yer="+emptyFrameCount);
			}
		}
	}
